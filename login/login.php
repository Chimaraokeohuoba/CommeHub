        ...
        if (isset($_POST['password']) && !empty($_POST['password'])){
            ...
            if ($baseData->getRecord(USERS,EMAIL,EMAIL,$email) != NULL){
                ...
                if ($password === $storedPassword){
                    ...
                    if (isset($_SESSION['requested-path'])){

                        header("Location:".$_SESSION['requested-path']);
                    }else{
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="contentDiv">
      <div>
        ...
        <div class="container jumbotron edge" style="background-color:rgba(255,255,255,1);border-radius:10px;">
          <h3><?php echo $_SESSION['login-prompt-msg']; ?> </h3>
    ...
    <script src="./pingle/transparent_to_solid_navbar.js"></script>
    <script src="./pingle/animated_arrow.js"></script>
    <script src="./pingle/back_to_top.js"></script>
